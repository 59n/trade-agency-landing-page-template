  ...
  return (
    <footer className="mt-16 border-t border-border bg-slate-50/50 px-4 pt-12 pb-10 sm:px-6">
      <div className="mx-auto max-w-[1160px]">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1fr_auto_1fr]">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
              Google Ads and enquiry tracking website template for trade businesses.
            </p>
          </div>
          ...
          <div className="space-y-3 lg:flex lg:flex-col lg:items-end lg:text-right">
            ...
            <p className="max-w-xs text-xs text-muted-foreground leading-relaxed">
              Add your business contact details in the site configuration.
            </p>
            {site.contactEmail ? (
              <ObfuscatedEmailLink
        ...
        {/* UK Statutory Trading Information & Disclosures */}
        <div className="mt-10 border-t border-border pt-6 space-y-3 text-xs text-muted-foreground leading-relaxed">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            {site.companyJurisdiction ? <><span>·</span><span>{site.companyJurisdiction}</span></> : null}
            {site.companyNumber ? (
              <>
                <span>·</span>
                <span>Company No. {site.companyNumber}</span>
              </>
            ) : null}
            {site.vatNumber ? (
              <>
                <span>·</span>
                <span>VAT Reg: {site.vatNumber}</span>
              </>
            ) : null}
          </div>

          <p className="text-[0.7rem] text-slate-400 leading-normal">
            Google Ads is a trademark of Google LLC. Replace this example copy with your actual business terms before launch.
          </p>
