...
const outcomes = [
  {
    icon: MessageSquare,
    title: "Genuine enquiry",
    body: "Direct phone call or quote request from a homeowner ready to hire.",
  },
  {
    icon: FileCheck2,
    title: "Survey & quote",
    body: "You visit or price up the work on your standard terms.",
  },
  {
    icon: UserCheck,
    title: "Paid trade job",
    body: "Work complete, customer pays you directly, no middleman cut.",
  },
]
  ...
  return (
    <figure className="process-diagram relative" aria-labelledby="process-illustration-title">
      <figcaption id="process-illustration-title" className="sr-only">
        Process from search to customer: a search for trade services near me, then enquiry, quote and customer.
      </figcaption>
